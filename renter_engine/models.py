...
class CarRent(models.Model):
    ...
    start_geo_lat = models.DecimalField(max_digits=10, decimal_places=7)
    start_geo_lon = models.DecimalField(max_digits=10, decimal_places=7)
    stop_geo_lat = models.DecimalField(null=True, blank=True, max_digits=10, decimal_places=7)
    stop_geo_lon = models.DecimalField(null=True, blank=True, max_digits=10, decimal_places=7)
